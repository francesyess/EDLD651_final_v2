...
Research question 1: 
What is the relationship between parent education and participant's education? 
```{r}
schoolingsub1 |> 
...
Research question 2: 
What is the relationship between parent education and participant's wage? 
```{r}
schoolingsub1 |> 
...
Research question 3: 
Is there a difference in wage depending on whether you lived near a collge?
```{r}
schoolingsub1 %>%   
